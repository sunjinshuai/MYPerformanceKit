...
@interface CaptivePortalWIFIManager ()<WKNavigationDelegate,UIAlertViewDelegate>
...
@implementation CaptivePortalWIFIManager

+ (instancetype)sharedInstance {
    static dispatch_once_t onceToken;
    static CaptivePortalWIFIManager *manager = nil;
    dispatch_once(&onceToken, ^{
        if (manager == nil) {
            manager = [[CaptivePortalWIFIManager alloc] init];
