...
- (void)configChildViewControllers {
    ...
    for(NSInteger i = 0; i < 4; i++) {
        MYSubScrollViewController *vc = [[MYSubScrollViewController alloc] init];
        [array addObject:vc];
    }
...
- (nullable UIViewController *)pageViewController:(UIPageViewController *)pageViewController viewControllerBeforeViewController:(UIViewController *)viewController {
    ...
    MYSubScrollViewController *vc = self.viewControlls[index -1];
    return vc;
}
...
@implementation MYSubScrollViewController
...
- (void)configScrollView {
    ...
    // scrollView需要支持侧滑返回
    [self addPopGestureToView:_scrollView];
